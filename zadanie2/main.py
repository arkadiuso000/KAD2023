...
#2nd plot
mf.generatePlot(myData, "sepal length", "petal length", "Długość działki kielicha (cm)", "Długość płatka (cm)",  list(np.linspace(4.0,8,num=9)), list(np.linspace(0,7.5,num=16)))
plt.savefig('./wykresy/wykres2.jpg')
# plt.show()

#3rd plot
mf.generatePlot(myData, "sepal length", "petal width", "Długość działki kielicha (cm)", "Szerokość płatka (cm)", list(np.linspace(4.0,8.0,num=9)),list(np.linspace(0,7.5,num=16)) )
plt.savefig('./wykresy/wykres3.jpg')
# plt.show()

#4th plot
mf.generatePlot(myData, "sepal width", "petal length", "Szerokość działki kielicha (cm)", "Długość płatka (cm)",  list(np.linspace(1.5,8.5,num=15)), list(np.linspace(0,7.5,num=16)))
plt.savefig('./wykresy/wykres4.jpg')
# plt.show()

#5th plot
mf.generatePlot(myData, "sepal width","petal width","Szerokość działki kielicha (cm)","Szerokość płatka (cm)",list(np.linspace(1.5,8.0,num=14)),list(np.linspace(0,7.5,num=16)))
plt.savefig('./wykresy/wykres5.jpg')
# plt.show()

#6th plot
mf.generatePlot(myData,"petal length","petal width","Długość płatka (cm)","Szerokość płatka (cm)", list(np.linspace(0.5,8.0,num=16)), list(np.linspace(0,7.5,num=16)))
